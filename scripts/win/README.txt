...
现有 `vs2017`, `qtcreator`, `cmake` 使用 SDK 的工程样例，在 "<SDK_ROOT_DIR>\samples\projects" 目录。
...
There are some project demos, including `vs2017` `qtcreator` `cmake`, under "<SDK_ROOT_DIR>\samples\projects" directory.
