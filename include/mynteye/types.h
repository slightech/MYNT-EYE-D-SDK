  ...
  union {
    ...
    struct {
      ...
      /**< Input image width(Single image) 
        *RECT_Scale_Col_N /RECT_Scale_Col_M */
      unsigned short	RECT_ScaleWidth;
      /**< Input image height(Single image) 
        *RECT_Scale_Row_N /RECT_Scale_Row_M */
			unsigned short	RECT_ScaleHeight;
      /**< Left Camera Matrix
        fx, 0, cx, 0, fy, cy, 0, 0, 1 
        fx,fy : focus  ; cx,cy : principle point */
			float         CamMat1[9];
      /**< Left Camera Distortion Matrix
      ...
      /**< Right Camera Matrix
        ...
        fx,fy : focus  ; cx,cy : principle point */
      float     CamMat2[9];
      /**< Right Camera Distortion Matrix
        k1, k2, p1, p2, k3, k4, k5, k6 
        k1~k6 : radial distort ; p1,p2 : tangential distort */
      float     CamDist2[8];
      /**< Rotation matrix between the left and right camera coordinate systems. 
        | [0] [1] [2] |       |Xcr|
      ...
      /**< 3x3 rectification transform (rotation matrix) for the left camera.
        ...
        | [6] [7] [8] |       |Zcr| */
      float     RRotaMat[9];
      /**< 3x4 projection matrix in the (rectified) coordinate systems for the left camera. 
        fx' 0 cx' 0 0 fy' cy' 0 0 0 1 0 
        fx',fy' : rectified focus ; cx', cy; : rectified principle point */
      float     NewCamMat1[12];
      /**< 3x4 projection matrix in the (rectified) coordinate systems for the rightt camera. 
      ...
      /**< Rectified image scale column factor N
