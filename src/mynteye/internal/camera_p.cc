...
ErrorCode CameraPrivate::RetrieveImage(cv::Mat* color_, cv::Mat* depth_) {
...
ErrorCode CameraPrivate::RetrieveImage(cv::Mat* color_, cv::Mat* depth_) {
  ...
  int ret = EtronDI_Get2Image(etron_di_, &dev_sel_info_,
    (BYTE*)color_img_buf_, (BYTE*)depth_img_buf_,  // NOLINT
...
int CameraPrivate::MJPEG_TO_RGB24_LIBJPEG(unsigned char* jpg, int nJpgSize,
    unsigned char* rgb) {
