...
int main(int argc, char const* argv[]) {
  ...
  std::cout << "\nTotal number of frames in color: " << left_total << std::endl;
  std::cout << "Total number of frames in depth: " << depth_total << std::endl;
  std::cout << "Total number of frames on the match: " << matched_total << std::endl << std::endl;
