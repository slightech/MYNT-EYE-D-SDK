# 通过设置参数获取不同类型的数据 {#get_all_with_options}
...
完整代码样例 [get_all_with_options](https://github.com/slightech/MYNT-EYE-D-SDK/blob/master/samples/src/get_all_with_options.cc) 。
